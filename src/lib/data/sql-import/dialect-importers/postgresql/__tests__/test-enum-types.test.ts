...
CREATE TABLE quests (
    ...
    const statusColumn = questsTable!.columns.find((c) => c.name === 'status');
...
`;
    ...
    const numberStatus = result.enums!.find((e) => e.name === 'number_status');
...
`;
    ...
    const spellStatus = result.enums!.find((e) => e.name === 'spell_status');
    ...
    const portalStatus = result.enums!.find((e) => e.name === 'portal_status');
