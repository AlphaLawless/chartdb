...
export const sortedDataTypeMap: Record<DatabaseType, readonly DataTypeData[]> =
  {
    ...
    [DatabaseType.MYSQL]: sortDataTypes([...dataTypeMap[DatabaseType.MYSQL]]),
    ...
    [DatabaseType.SQLITE]: sortDataTypes([...dataTypeMap[DatabaseType.SQLITE]]),
    ...
    [DatabaseType.ORACLE]: sortDataTypes([...dataTypeMap[DatabaseType.ORACLE]]),
  } as const;
...
export const findDataTypeDataById = (
  ...
  const dataTypesOptions = databaseType ? dataTypeMap[databaseType] : dataTypes;
