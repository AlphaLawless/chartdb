...
ALTER TABLE wizard_spellbooks ADD CONSTRAINT fk_mentor FOREIGN KEY (owner_id) REFERENCES wizards (id);`;
      ...
      expect(sanitized).toContain('ADD CONSTRAINT fk_mentor_1 FOREIGN KEY');
      expect(sanitized).toContain('ADD CONSTRAINT fk_mentor_2 FOREIGN KEY');
    });
...
ALTER TABLE wizards ADD CONSTRAINT fk_wizard_self FOREIGN KEY (id) REFERENCES wizards (id);`;
      ...
      expect(sanitized).toContain('ALTER TABLE guild_hierarchy ADD CONSTRAINT');
...
ALTER TABLE spell_component_links ADD CONSTRAINT fk_creator FOREIGN KEY (link_id) REFERENCES component_links (id);`;
      ...
      expect(sanitized).toContain('ADD CONSTRAINT fk_creator FOREIGN KEY');
      expect(sanitized).toContain('ADD CONSTRAINT fk_creator_1 FOREIGN KEY');
