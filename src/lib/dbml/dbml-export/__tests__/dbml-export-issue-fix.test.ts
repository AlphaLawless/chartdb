...
describe('DBML Export - Issue Fixes', () => {
  ...
  it('should export table and field comments to DBML', () => {
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              nullable: false,
              unique: false,
              comments: 'Reference to the user who created the post',
              collation: null,
              default: null,
              characterMaximumLength: null,
              createdAt: Date.now(),
    ...
    expect(result.standardDbml).toContain("Note: 'Stores user information'");
  ...
  it('should export index names correctly in DBML', () => {
    ...
    expect(result.standardDbml).toContain('email [unique, name: "idx_email"]');
    expect(result.standardDbml).toContain(
    ...
    expect(indexSection![0]).toContain('created_at [name: "idx_created_at"]');
