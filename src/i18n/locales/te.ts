...
export const te: LanguageTranslation = {
  translation: {
    ...
    delete_diagram_alert: {
      ...
      description: 'ఈ చర్యను తిరిగి చేయలేరు. ఇది చిత్రాన్ని శాశ్వతంగా తొలగిస్తుంది.',
      cancel: 'రద్దు',
      delete: 'తొలగించు',
    },
    ...
    clear_diagram_alert: {
      ...
      description: 'ఈ చర్యను తిరిగి చేయలేరు. ఇది చిత్రంలో ఉన్న అన్ని డేటాను శాశ్వతంగా తొలగిస్తుంది.',
      cancel: 'రద్దు',
      clear: 'తొలగించు',
    },
    ...
    new_diagram_dialog: {
      database_selection: {
        ...
        description: 'ప్రతి డేటాబేస్‌కు ప్రత్యేక లక్షణాలు మరియు సామర్థ్యాలు ఉంటాయి.',
      ...
      import_database: {
        ...
        ssms_instructions: {
          ...
          step_2:
            'మీరు "Results to Grid" ఉపయోగిస్తే, Maximum Characters Retrieved for Non-XML డేటా (9999999 కు సెట్ చేయండి) మార్చండి.',
        },
    ...
    export_sql_dialog: {
      title: 'SQL ఎగుమతి',
      description: 'మీ చిత్ర స్కీమాను {{databaseType}} స్క్రిప్ట్‌గా ఎగుమతి చేయండి',
      close: 'మూసి వేయండి',
      loading: {
    ...
    import_database_dialog: {
      ...
      override_alert: {
        ...
        content: {
          alert:
            'ఈ చిత్రాన్ని దిగుమతి చేసుకోవడం మునుపటి పట్టికలు మరియు సంబంధాలను ప్రభావితం చేస్తుంది.',
          new_tables: '<bold>{{newTablesNumber}}</bold> కొత్త పట్టికలు జోడించబడతాయి.',
          new_relationships:
    ...
    new_table_schema_dialog: {
      ...
      description: 'ప్రస్తుతం బహుళ స్కీమాలు చూపబడుతున్నాయి. కొత్త పట్టిక కోసం ఒకటి ఎంచుకోండి.',
      cancel: 'రద్దు',
      confirm: 'కన్ఫర్మ్',
    },
    ...
    star_us_dialog: {
      ...
      description: 'మీకు GitHub‌లో మాకు స్టార్ ఇవ్వాలనుకుంటున్నారా? కేవలం ఒక క్లిక్ మాత్రమే!',
      close: 'ఇప్పుడు కాదు',
      confirm: 'ఖచ్చితంగా!',
    },
    ...
    export_diagram_dialog: {
      ...
      error: {
        ...
        description: 'Something went wrong. Need help? support@chartdb.io',
      },
    },
