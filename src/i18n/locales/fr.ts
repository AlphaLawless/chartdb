  ...
  translation: {
    ...
    side_panel: {
      ...
      tables_section: {
        ...
        no_results: 'Aucune table trouvée correspondant à votre filtre.',
    ...
    new_diagram_dialog: {
      ...
      import_database: {
        ...
        ssms_instructions: {
          ...
          title: 'Instructions',
          step_1:
            'Allez dans Outils > Options > Résultats des Requêtes > SQL Server.',
          step_2:
            'Si vous utilisez "Résultats en Grille", changez le nombre maximum de caractères récupérés pour les données non-XML (définir à 9999999).',
        },
    ...
    import_database_dialog: {
      ...
      override_alert: {
        ...
        content: {
          alert:
            "L'importation de ce diagramme affectera les tables et relations existantes.",
          new_tables:
    ...
    import_dbml_dialog: {
      ...
      error: {
        title: 'Erreur',
        description: "Erreur d'analyse du DBML. Veuillez vérifier la syntaxe.",
      },
    },
    relationship_type: {
      one_to_one: 'Un à Un',
    ...
    snap_to_grid_tooltip: 'Aligner sur la grille (maintenir la touche {{key}})',
