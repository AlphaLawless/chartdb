  ...
  translation: {
    ...
    new_diagram_dialog: {
      ...
      import_database: {
        ...
        ssms_instructions: {
          ...
          step_2:
            'Jika Anda menggunakan "Hasil ke Grid," ubah Jumlah Karakter yang Diterima untuk Data Non-XML (disetel ke 9999999).',
        },
    ...
    import_database_dialog: {
      ...
      override_alert: {
        ...
        content: {
          alert:
            'Mengimpor diagram ini akan memengaruhi tabel dan hubungan yang ada.',
          new_tables:
    ...
    export_diagram_dialog: {
      ...
      error: {
        ...
        description: 'Sesuatu yang salah. Butuh bantuan? support@chartdb.io',
      },
    },
