  ...
  translation: {
    ...
    new_diagram_dialog: {
      ...
      import_database: {
        ...
        ssms_instructions: {
          ...
          title: 'Anweisungen',
          step_1:
            'Gehen Sie zu Tools > Optionen > Abfrageergebnisse > SQL Server.',
          step_2:
            'Wenn Sie "Ergebnisse in Raster" verwenden, ändern Sie die maximale Zeichenanzahl für Nicht-XML-Daten (auf 9999999 setzen).',
        },
    ...
    import_database_dialog: {
      ...
      override_alert: {
        ...
        content: {
          alert:
            'Das Importieren dieses Diagramms wird vorhandene Tabellen und Beziehungen beeinflussen.',
          new_tables:
