  ...
  translation: {
    ...
    new_diagram_dialog: {
      ...
      import_database: {
        ...
        ssms_instructions: {
          ...
          title: 'Instruções',
          step_1:
            'Vá para Ferramentas > Opções > Resultados da Consulta > SQL Server.',
          step_2:
            'Se estiver usando "Resultados para Grade," altere o Máximo de Caracteres para Dados Não-XML (definido para 9999999).',
        },
    ...
    import_database_dialog: {
      ...
      override_alert: {
        ...
        content: {
          alert:
            'A importação deste diagrama afetará tabelas e relacionamentos existentes.',
          new_tables:
