...
export const ne: LanguageTranslation = {
  translation: {
    ...
    delete_diagram_alert: {
      ...
      description: 'यो कार्य पूर्ववत गर्न सकिँदैन। यो डायाग्राम स्थायी रूपमा हटाउनेछ।',
    ...
    export_sql_dialog: {
      ...
      description: 'तलको विकल्पहरूबाट तपाईंको डायाग्राम स्कीम निर्यात गर्नुहोस्।',
    ...
    import_database_dialog: {
      ...
      override_alert: {
        ...
        content: {
          ...
          new_tables: '<bold>{{newTablesNumber}}</bold> नयाँ तालिकाहरू थपिनेछन्।',
          new_relationships:
