  ...
  translation: {
    ...
    new_diagram_dialog: {
      ...
      import_database: {
        ...
        ssms_instructions: {
          ...
          step_2:
            '"결과를 그리드로 표시"를 사용하는 경우 비 XML 데이터에 대해 검색되는 최대 문자 수를 변경합니다. (9999999로 설정)',
        },
    ...
    import_database_dialog: {
      ...
      override_alert: {
        ...
        content: {
          alert:
            '이 다이어그램을 가져오면 기존 테이블 및 연관 관계에 영향을 미칩니다.',
          new_tables: '<bold>{{newTablesNumber}}</bold>개의 신규 테이블 생성됨',
          new_relationships:
