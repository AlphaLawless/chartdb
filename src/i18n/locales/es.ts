  ...
  translation: {
    ...
    new_diagram_dialog: {
      ...
      import_database: {
        ...
        ssms_instructions: {
          ...
          title: 'Instrucciones',
          step_1:
            'Ve a Herramientas > Opciones > Resultados de Consulta > SQL Server.',
          step_2:
            'Si estás usando "Resultados en Cuadrícula", cambia el Máximo de Caracteres Recuperados para Datos No XML (configúralo en 9999999).',
        },
    ...
    import_database_dialog: {
      ...
      override_alert: {
        ...
        content: {
          alert:
            'Importar este diagrama afectará las tablas y relaciones existentes.',
          new_tables:
