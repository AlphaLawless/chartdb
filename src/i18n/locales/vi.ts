  ...
  translation: {
    ...
    new_diagram_dialog: {
      ...
      import_database: {
        ...
        ssms_instructions: {
          ...
          step_2:
            'Nếu bạn đang sử dụng "Results to Grid," thay đổi Maximum Characters Retrieved cho Non-XML (đặt thành 9999999).',
        },
    ...
    import_database_dialog: {
      ...
      override_alert: {
        ...
        content: {
          alert:
            'Việc nhập sơ đồ này sẽ ảnh hưởng đến các bảng và mối quan hệ hiện có.',
          new_tables:
    ...
    export_diagram_dialog: {
      ...
      error: {
        ...
        description: 'Có gì đó không ổn. Cần trợ giúp? support@chartdb.io',
      },
    },
