  ...
  translation: {
    ...
    side_panel: {
      ...
      tables_section: {
        ...
        collapse: 'Sažmi sve',
        clear: 'Očisti filter',
        no_results: 'Nema pronađenih tablica koje odgovaraju vašem filteru.',
      ...
      areas_section: {
        ...
        filter: 'Filtriraj',
        clear: 'Očisti filter',
        no_results: 'Nema pronađenih područja koja odgovaraju vašem filteru.',
      ...
      custom_types_section: {
        ...
        custom_type: {
          ...
          add_field: 'Dodaj polje',
          no_fields_tooltip: 'Nema definiranih polja za ovaj prilagođeni tip',
          custom_type_actions: {
            title: 'Radnje',
    ...
    new_diagram_dialog: {
      ...
      import_database: {
        ...
        ssms_instructions: {
          ...
          step_2:
            'Ako koristite "Results to Grid," promijenite Maximum Characters Retrieved za Non-XML podatke (postavite na 9999999).',
        },
    ...
    export_sql_dialog: {
      title: 'Izvezi SQL',
      description: 'Izvezite shemu vašeg dijagrama u {{databaseType}} skriptu',
      close: 'Zatvori',
      loading: {
    ...
    export_diagram_dialog: {
      ...
      error: {
        ...
        description: 'Nešto je pošlo po zlu. Trebate pomoć? support@chartdb.io',
      },
    },
