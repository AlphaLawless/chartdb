...
import { FileMinus2, FileOutput, FileType2 } from 'lucide-react';
...
> = ({ dialog, sourceTableId: preSelectedSourceTableId }) => {
  ...
  return (
    ...
    >
      ...
      >
        <DialogHeader>
          <DialogTitle>{t('create_relationship_dialog.title')}</DialogTitle>
        </DialogHeader>
              ...
              <div className="flex min-w-0 grow-0">
                <SelectBox
                  ...
                  onChange={(value) => {
                    ...
                    if (newTableId !== preSelectedSourceTableId) {
                      setPrimaryFieldId(undefined);
                    }
                  }}
                  emptyPlaceholder={t(
              ...
              <div>
                <div className="flex min-w-0 grow-0">
                  <SelectBox
                    ...
                    onChange={(value) => setPrimaryFieldId(value as string)}
                    emptyPlaceholder={t(
              ...
              <div>
                <div className="flex min-w-0 grow-0">
                  <SelectBox
                    ...
                    onChange={(value) => setReferencedFieldId(value as string)}
                    emptyPlaceholder={t(
                      'create_relationship_dialog.no_fields_found'
                    )}
                  />
