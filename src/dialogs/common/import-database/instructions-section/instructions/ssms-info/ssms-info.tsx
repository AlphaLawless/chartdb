...
>(({ open: controlledOpen, setOpen: setControlledOpen }, ref) => {
  ...
  const isOpen = useMemo(() => open || controlledOpen, [open, controlledOpen]);
        ...
        <div className="flex flex-col">
          <div className="flex items-start justify-between">
            <h4 className="text-sm font-semibold">
              {t('new_diagram_dialog.import_database.ssms_instructions.title')}
            </h4>
            <button
          ...
          <div className="space-y-1">
            <p className="text-xs text-muted-foreground">
              ...
              {t('new_diagram_dialog.import_database.ssms_instructions.step_1')}
            </p>
            <p className="text-xs text-muted-foreground">
              <span className="font-semibold">2. </span>
              {t('new_diagram_dialog.import_database.ssms_instructions.step_2')}
            </p>
