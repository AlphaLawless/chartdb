...
import { Group, Table, View, Workflow } from 'lucide-react';
...
export const CanvasContextMenu: React.FC<React.PropsWithChildren> = ({
  ...
  const createTableHandler = useCallback(
    ...
    [createTable, screenToFlowPosition, openTableSchemaDialog, schemasDisplayed]
  );
  ...
  return (
    <ContextMenu>
      <ContextMenuTrigger disabled={readonly}>{children}</ContextMenuTrigger>
      <ContextMenuContent>
        <ContextMenuItem
