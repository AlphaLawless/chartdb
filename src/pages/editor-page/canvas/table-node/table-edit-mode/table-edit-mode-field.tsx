      ...
      >
            ...
            <TooltipTrigger asChild>
              <span className="min-w-0 flex-1">
                <Input
                  ...
                  type="text"
                  placeholder={t('side_panel.tables_section.table.field_name')}
                  value={fieldName}
            ...
            <TooltipTrigger className="flex h-8 min-w-0 flex-1" asChild>
              <span>
                <SelectBox
                  ...
                  optionSuffix={(option) => generateFieldSuffix(option.value)}
        ...
        <div className="flex shrink-0 items-center justify-end gap-1">
          ...
          <Tooltip>
            ...
            <TooltipContent>
              {t('side_panel.tables_section.table.field_actions.delete_field')}
            </TooltipContent>
          </Tooltip>
        </div>
      </div>
