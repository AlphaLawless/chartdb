    ...
    ({
      ...
      const edgeNumber = useMemo(() => {
        ...
        for (const rel of relationships) {
          if (
            (rel.targetTableId === target && rel.sourceTableId === source) ||
            (rel.targetTableId === source && rel.sourceTableId === target)
          ) {
        ...
        <>
          <path
            ...
            className={cn([
              ...
              {
                '!stroke-green-500 !stroke-[3px]': isDiffNewRelationship,
                '!stroke-red-500 !stroke-[3px]': isDiffRelationshipRemoved,
              },
            ])}
            onClick={(e) => {
              if (e.detail === 2) {
