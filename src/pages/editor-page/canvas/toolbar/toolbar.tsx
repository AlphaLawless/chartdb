        ...
        <CardContent className="flex h-full flex-row items-center p-1">
          <Tooltip>
            ...
            <TooltipContent>
              ...
              <span className="ml-2 text-muted-foreground">
                {
                  keyboardShortcutsForOS[KeyboardShortcutAction.TOGGLE_FILTER]
                    .keyCombinationLabel
                }
              </span>
            </TooltipContent>
          ...
          <Tooltip>
            ...
            <TooltipContent>
              ...
              <span className="ml-2 text-muted-foreground">
                {
                  keyboardShortcutsForOS[KeyboardShortcutAction.SHOW_ALL]
                    .keyCombinationLabel
                }
              </span>
            </TooltipContent>
          ...
          {!readonly ? (
            <>
              <Tooltip>
                <TooltipTrigger asChild>
                  <span>
                    <ToolbarButton onClick={showReorderConfirmation}>
                      <LayoutGrid />
                    </ToolbarButton>
                  </span>
                </TooltipTrigger>
                <TooltipContent>{t('toolbar.reorder_diagram')}</TooltipContent>
              </Tooltip>
              <Separator orientation="vertical" />
            </>
          ) : null}
