          ...
          <div className="flex basis-1/2 flex-col gap-2 overflow-hidden text-xs">
            <div className="flex flex-row items-center gap-1">
              ...
              <div className="font-bold text-subtitle">
                {t('side_panel.refs_section.dependency.dependent_table')}
              </div>
            </div>
            <Tooltip>
              <TooltipTrigger>
              ...
              <TooltipContent>{dependentTable?.name}</TooltipContent>
            </Tooltip>
          </div>
          <div className="flex basis-1/2 flex-col gap-2 overflow-hidden text-xs">
            <div className="flex flex-row items-center gap-1">
            ...
            <Tooltip>
              <TooltipTrigger>
                <div className="truncate text-left text-sm">{table?.name}</div>
              </TooltipTrigger>
      ...
      <div className="flex flex-1 items-center justify-center pt-2">
        ...
        >
          ...
          <div className="text-red-700">
            {t('side_panel.refs_section.dependency.delete_dependency')}
          </div>
        </Button>
      </div>
    </div>
