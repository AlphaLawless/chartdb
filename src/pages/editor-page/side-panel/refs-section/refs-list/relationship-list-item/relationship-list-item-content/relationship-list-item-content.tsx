      ...
      <div className="flex flex-col gap-6">
        <div className="flex items-center justify-between gap-1 text-xs">
            ...
            <Tooltip>
              <TooltipTrigger>
                <div className="truncate text-left text-sm">
                  {sourceTable?.schema ? `${sourceTable.schema}.` : ''}
          ...
          <div className="flex basis-1/2 flex-col gap-2 overflow-hidden text-xs">
            ...
            <Tooltip>
              <TooltipTrigger>
                <div className="truncate text-left text-sm">
                  {targetTable?.schema ? `${targetTable.schema}.` : ''}
        ...
        <div className="flex flex-col gap-2 text-xs">
          <div className="flex flex-row items-center gap-1">
            ...
            <div className="font-bold text-subtitle">
              {t('side_panel.refs_section.relationship.cardinality')}
            </div>
          </div>
        ...
        <div className="flex flex-1 items-center justify-center pt-2">
          ...
          >
            ...
            <div className="text-red-700">
              {t('side_panel.refs_section.relationship.delete_relationship')}
            </div>
          </Button>
        </div>
      ) : null}
