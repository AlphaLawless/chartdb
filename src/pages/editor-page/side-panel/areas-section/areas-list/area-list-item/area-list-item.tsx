      ...
      () => (
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-fit min-w-40">
            <DropdownMenuLabel>
              {t('side_panel.areas_section.area.area_actions.title')}
            </DropdownMenuLabel>
            <DropdownMenuSeparator />
            <DropdownMenuGroup>
              <DropdownMenuItem
              ...
              >
                {t('side_panel.areas_section.area.area_actions.edit_name')}
            ...
            <DropdownMenuGroup>
              ...
              >
                {t('side_panel.areas_section.area.area_actions.delete_area')}
            ...
            {!editMode ? (
              <div className="flex flex-row-reverse items-center gap-1">
                ...
                <div className="hidden md:group-hover:flex">
                  <ListItemHeaderButton onClick={handleFocusOnArea}>
                    <CircleDotDashed />
                  </ListItemHeaderButton>
                </div>
              </div>
