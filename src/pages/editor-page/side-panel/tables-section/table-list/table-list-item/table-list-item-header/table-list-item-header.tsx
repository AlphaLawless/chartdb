  ...
  const updateTableSchema = useCallback(
    ({ schema }: { schema: DBSchema }) => {
      updateTablesState((currentTables) =>
        currentTables.map((t) =>
          t.id === table.id || !t.schema ? { ...t, schema: schema.name } : t
        )
      );
    },
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-fit min-w-40">
          ...
          <DropdownMenuGroup>
            ...
            >
              {t('side_panel.tables_section.table.table_actions.add_field')}
            ...
            >
              {t('side_panel.tables_section.table.table_actions.add_index')}
          ...
          <DropdownMenuGroup>
            ...
            >
              {t('side_panel.tables_section.table.table_actions.delete_table')}
