import { Ellipsis, KeyRound, Trash2 } from 'lucide-react';
  ...
  return (
    <div className="flex flex-1 flex-row justify-between gap-2 p-1">
      <SelectBox
        ...
        placeholder={t('side_panel.tables_section.table.index_select_fields')}
      ...
      <div className="flex shrink-0 gap-1">
        {index.isPrimaryKey ? (
          ...
          <Tooltip>
            ...
            <TooltipContent>
              {t('side_panel.tables_section.table.index_actions.unique')}
            </TooltipContent>
          </Tooltip>
        )}
        <Popover>
          ...
          <PopoverContent className="w-52">
            <div className="flex flex-col gap-2">
              <div className="text-sm font-semibold">
                {t('side_panel.tables_section.table.index_actions.title')}
              </div>
              <Separator orientation="horizontal" />
              <div className="flex flex-col gap-2">
                <Label htmlFor="width" className="text-subtitle">
                  {t('side_panel.tables_section.table.index_actions.name')}
                </Label>
                <Input
                  value={index.name}
                  onChange={(value) =>
