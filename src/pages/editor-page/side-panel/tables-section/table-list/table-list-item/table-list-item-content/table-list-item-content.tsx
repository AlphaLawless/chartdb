...
import { FileKey2, FileType2, MessageCircleMore, Plus } from 'lucide-react';
              ...
              >
                {table.fields.map((field) => (
                  <TableField
                    ...
                    field={field}
                    table={table}
                    updateField={(attrs) => handleFieldUpdate(field.id, attrs)}
        ...
        <AccordionItem value="comments" className="border-y-0">
          ...
          <AccordionContent className="pb-0 pt-1">
            <Textarea
              ...
              placeholder={t('side_panel.tables_section.table.no_comments')}
