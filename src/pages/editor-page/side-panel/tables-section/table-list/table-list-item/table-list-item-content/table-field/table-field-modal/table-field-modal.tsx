      ...
      <PopoverContent className="w-52">
        <div className="flex flex-col gap-2">
          <div className="text-sm font-semibold">
            {t('side_panel.tables_section.table.field_actions.title')}
          </div>
          <Separator orientation="horizontal" />
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-between">
              <Label htmlFor="width" className="text-subtitle">
                {t('side_panel.tables_section.table.field_actions.unique')}
              </Label>
              <Checkbox
            ...
            {supportsAutoIncrement ? (
              <div className="flex items-center justify-between">
                <Label htmlFor="increment" className="text-subtitle">
                  {t(
                ...
                <Checkbox
                  ...
                  disabled={!localField.primaryKey || readonly}
                  onCheckedChange={(value) =>
                    setLocalField((current) => ({
                      ...current,
                      increment: !!value,
            ...
            {dataFieldType?.fieldAttributes?.hasCharMaxLength ? (
              <div className="flex flex-col gap-2">
                ...
                {dataFieldType?.fieldAttributes?.hasCharMaxLengthOption ? (
                  <div className="flex gap-2">
                    <Select
                      value={
                        localField.characterMaximumLength === 'max'
                          ? 'max'
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="none">No length</SelectItem>
                    ...
                    localField.characterMaximumLength !== 'max' ? (
                      <Input
                        value={localField.characterMaximumLength}
                        type="number"
                        min="1"
                        max={
                          dataFieldType?.fieldAttributes?.maxLength || undefined
                        }
                        onChange={(e) =>
                          setLocalField((current) => ({
                            ...current,
            ...
            dataFieldType?.fieldAttributes?.scale ? (
              <div className="flex gap-2">
                ...
                <div className="flex flex-1 flex-col gap-2">
                  <Label htmlFor="width" className="text-subtitle">
                    {t('side_panel.tables_section.table.field_actions.scale')}
                  </Label>
                  <Input
            ...
            <div className="flex flex-col gap-2">
              <Label htmlFor="width" className="text-subtitle">
                {t('side_panel.tables_section.table.field_actions.comments')}
              </Label>
              <Textarea
