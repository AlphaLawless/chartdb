    ...
    <Menubar className="h-8 border-none py-2 shadow-none md:h-10 md:py-0">
      <MenubarMenu>
        ...
        <MenubarContent>
          ...
          <MenubarSeparator />
          <MenubarSub>
            <MenubarSubTrigger>{t('menu.actions.import')}</MenubarSubTrigger>
            <MenubarSubContent>
              <MenubarItem onClick={openImportDiagramDialog}>.json</MenubarItem>
          ...
          <MenubarSub>
            ...
            <MenubarSubContent>
              {databaseType === DatabaseType.GENERIC ? (
                <MenubarItem onClick={() => exportSQL(DatabaseType.GENERIC)}>
                  {databaseTypeToLabelMap['generic']}
                </MenubarItem>
              ) : null}
              {databaseType !== DatabaseType.GENERIC ? (
                <MenubarItem onClick={() => exportSQL(databaseType)}>
                  {databaseTypeToLabelMap[databaseType]}
                </MenubarItem>
              ) : null}
              {databaseType !== DatabaseType.POSTGRESQL ? (
                <MenubarItem onClick={() => exportSQL(DatabaseType.POSTGRESQL)}>
                  {databaseTypeToLabelMap['postgresql']}
              ...
              {databaseType !== DatabaseType.MYSQL ? (
                <MenubarItem onClick={() => exportSQL(DatabaseType.MYSQL)}>
                  {databaseTypeToLabelMap['mysql']}
                  <MenubarShortcut className="text-base">
                    {emojiAI}
                  </MenubarShortcut>
              ...
              {databaseType !== DatabaseType.SQL_SERVER ? (
                <MenubarItem onClick={() => exportSQL(DatabaseType.SQL_SERVER)}>
                  {databaseTypeToLabelMap['sql_server']}
                  <MenubarShortcut className="text-base">
                    {emojiAI}
                  </MenubarShortcut>
              ...
              {databaseType !== DatabaseType.MARIADB ? (
                <MenubarItem onClick={() => exportSQL(DatabaseType.MARIADB)}>
                  {databaseTypeToLabelMap['mariadb']}
                  <MenubarShortcut className="text-base">
                    {emojiAI}
                  </MenubarShortcut>
              ...
              {databaseType !== DatabaseType.SQLITE ? (
                <MenubarItem onClick={() => exportSQL(DatabaseType.SQLITE)}>
                  {databaseTypeToLabelMap['sqlite']}
                  <MenubarShortcut className="text-base">
                    {emojiAI}
                  </MenubarShortcut>
          ...
          <MenubarSub>
            <MenubarSubTrigger>{t('menu.actions.export_as')}</MenubarSubTrigger>
            <MenubarSubContent>
              ...
              <MenubarSeparator />
              <MenubarItem onClick={openExportDiagramDialog}>JSON</MenubarItem>
            </MenubarSubContent>
          </MenubarSub>
          <MenubarSeparator />
          <MenubarItem
      ...
      <MenubarMenu>
        ...
        <MenubarContent>
          <MenubarItem onClick={undo} disabled={!hasUndo}>
            ...
            <MenubarShortcut>
              {
                keyboardShortcutsForOS[KeyboardShortcutAction.UNDO]
                  .keyCombinationLabel
              }
            </MenubarShortcut>
          </MenubarItem>
          <MenubarItem onClick={redo} disabled={!hasRedo}>
            ...
            <MenubarShortcut>
              {
                keyboardShortcutsForOS[KeyboardShortcutAction.REDO]
                  .keyCombinationLabel
              }
            </MenubarShortcut>
          </MenubarItem>
          ...
          <MenubarItem
            onClick={() =>
              showAlert({
                ...
                description: t('clear_diagram_alert.description'),
      ...
      <MenubarMenu>
        ...
        <MenubarContent>
          ...
          <MenubarSeparator />
          <MenubarSub>
            <MenubarSubTrigger>{t('menu.view.show_views')}</MenubarSubTrigger>
            <MenubarSubContent>
              <MenubarCheckboxItem
                checked={showDBViews}
